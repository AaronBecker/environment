...
if !hasmapto('<Plug>AM_Ts,') |map <unique> <Leader>As,		<Plug>AM_Ts,|endif
if !hasmapto('<Plug>AM_T:')	 |map <unique> <Leader>A:		<Plug>AM_T:|endif
if !hasmapto('<Plug>AM_T;')	 |map <unique> <Leader>A;		<Plug>AM_T;|endif
if !hasmapto('<Plug>AM_T<')	 |map <unique> <Leader>A<		<Plug>AM_T<|endif
if !hasmapto('<Plug>AM_T=')	 |map <unique> <Leader>A=		<Plug>AM_T=|endif
if !hasmapto('<Plug>AM_T?')	 |map <unique> <Leader>A?		<Plug>AM_T?|endif
if !hasmapto('<Plug>AM_T@')	 |map <unique> <Leader>A@		<Plug>AM_T@|endif
if !hasmapto('<Plug>AM_Tab') |map <unique> <Leader>Aab		<Plug>AM_Tab|endif
...
if !hasmapto('<Plug>AM_tt')		|map <unique> <Leader>at	<Plug>AM_tt|endif
