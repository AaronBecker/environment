...
exec "Snippet once #ifndef ``CMacroName(expand('%'))``<CR><CR>#define ``CMacroName(expand('%'))``<CR><CR>".st.et."<CR><CR>#endif /* ``CMacroName(expand('%'))`` */<CR>"
...
exec "Snippet vector std::vector<".st."int".et."> ".st.et.";"
...
"exec "Snippet for for (".st."int i=0".et."; ".st."i<n".et."; ".st."++i".et.") {<CR>".st.et."<CR>}<CR>".st.et
