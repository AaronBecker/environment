...
exec "Snippet method /**<CR> ".st.et."<CR> <BS><BS><BS>/<CR>public ".st."return".et." ".st."method".et."() {<CR>".st.et."<CR>}<CR>".st.et
...
exec "Snippet sout System.out.println(\"".st.et."\");<CR>".st.et
...
exec "Snippet else if (".st.et.") {<CR>".st.et."<CR>} else {<CR>".st.et."<CR>}<CR>".st.et
