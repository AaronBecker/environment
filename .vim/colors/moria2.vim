...
if &background == "dark"
    if s:moria_style == "dark"
        hi Normal ctermbg=Black ctermfg=LightGray guibg=#141414 guifg=#ffffff gui=none
    ...
    elseif s:moria_style == "black"
        hi Normal ctermbg=Black ctermfg=LightGray guibg=#000000 guifg=#ffffff gui=none
